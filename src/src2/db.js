export const heroes = [{ name: 'antimage', id: 1, localized_name: 'Anti-Mage' },

{ name: 'axe', id: 2, localized_name: 'Axe' },

{ name: 'bane', id: 3, localized_name: 'Bane' },

{ name: 'bloodseeker', id: 4, localized_name: 'Bloodseeker' + `bs` },

{ name: 'crystal_maiden', id: 5, localized_name: 'Crystal Maiden' + `cm` },
...
{ name: 'nevermore', id: 11, localized_name: 'Shadow Fiend' + `sf` },
...
{ name: 'windrunner', id: 21, localized_name: 'Windranger' + `wr` },
...
{ name: 'witch_doctor', id: 30, localized_name: 'Witch Doctor' + `wd` },
...
{ name: 'furion', id: 53, localized_name: "Nature's Prophet" + `furion` },
